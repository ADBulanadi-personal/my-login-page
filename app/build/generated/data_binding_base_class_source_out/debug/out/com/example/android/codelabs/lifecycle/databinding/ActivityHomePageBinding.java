...
public final class ActivityHomePageBinding implements ViewBinding {
  ...
  private ActivityHomePageBinding(@NonNull LinearLayout rootView, @NonNull TextView WelcomeText) {
  ...
  public static ActivityHomePageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityHomePageBinding((LinearLayout) rootView, WelcomeText);
    }
